...
const spreads = [
    // Spread 0: Presentación y Biografía
    {
        ...
        `,
        rightContent: `
            <h3 class="page-title" style="font-weight: bold;">Mi Historia</h3>
    ...
    // Spread 1: Obras Escritas (Libros)
    {
        leftContent: `
            <h3 class="page-title">Obras Destacadas (I)</h3>
            <div style="display:flex; align-items:flex-start; gap:1rem; margin-bottom:2rem;">
                <img src="img/portada LHO.jpeg" onerror="this.src='https://placehold.co/80x120/a855f7/ffffff?text=ECO';" alt="Cubierta" style="margin-top: 1.5rem; height:128px; width:80px; object-fit:cover; border-radius:6px; box-shadow:0 6px 18px rgba(0,0,0,0.08);">
                <div style="margin-top: 1.5rem; padding-left:0.75rem; border-left:4px solid #9ca3af;">
        ...
        rightContent: `
            ...
            <div style="display:flex; align-items:flex-start; gap:1rem; margin-bottom:2rem;">
                <img src="https://placehold.co/80x120/10b981/ffffff?text=<>" onerror="this.src='https://placehold.co/80x120/10b981/ffffff?text=JARDIN';" alt="Cubierta" style="margin-top: 1.5rem; height:128px; width:80px; object-fit:cover; border-radius:6px;">
                <div style="margin-top: 1.5rem; padding-left:0.75rem; border-left:4px solid #9ca3af;">
                    ...
                    <p class="page-text" style="margin:0 0 0.25rem; font-size:0.95rem;">
                        Una historia de ficción, llena de acción y aventura en el mundo moderno.
                    </p>
    ...
    {
        leftContent: `
            <h3 class="page-title" style="font-weight: bold;">Hablemos</h3>
            ...
            <ul style="margin-left:0.5rem; line-height:1.6;">
                ...
                <li style="padding-left:1rem;">
                    Instagram: 
                    <a href="https://www.instagram.com/chris_h.autor" class="book-link" target="_blank" rel="noopener">@chris_h.autor</a>
                </li>
                <li style="padding-left:1rem;">
                    TikTok: 
                    <a href="https://www.tiktok.com/@chris.h.autor" class="book-link" target="_blank" rel="noopener">@chris.h.autor</a>
                </li>
            </ul>
        `,
        rightContent: `
            <h3 class="page-title" style="font-weight: bold;">Colaboraciones</h3>
            <div style="display:flex; align-items:center; gap:1rem; margin-bottom:1rem;">
                <img src="img/bitacoras.jpg" alt="Portada de Bitácoras de Viajeros Errantes"
                     style="height:150px; width:auto; object-fit:cover; border-radius:6px; margin-bottom:78px; box-shadow:0 6px 18px rgba(0,0,0,0.12);"
                ...
                <div>
                    ...
                    <p class="page-text" style="margin-top:1rem; font-size:0.95rem;">
                        ...
                        <a href="https://www.amazon.com.mx/Bit%C3%A1coras-viajeros-errantes-Rubin/dp/6310023543" target="_blank" class="book-link">
                            Ver en Amazon →
                        </a>
                    </p>
                </div>
    ...
    {
        leftContent: `
            <h3 class="page-title" style="font-weight: bold;">Agradecimientos</h3>
        ...
        rightContent: `
            ...
            <p class="page-text mb-4" style="font-size:1rem;">
...
function animatePage(direction, callback){
    // Desactivar botones mientras se actualiza
    prevBtn.disabled = true;
    nextBtn.disabled = true;

    // Simplemente llama al callback para actualizar la página
    callback();

    // Reactivar botones según el spread actual
...
function turnPage(direction){
    if(direction==='forward' && currentSpreadIndex < spreads.length-1){
        animatePage('forward', ()=> { currentSpreadIndex++; renderSpread(currentSpreadIndex); });
    } else if(direction==='backward' && currentSpreadIndex > 0){
        animatePage('backward', ()=> { currentSpreadIndex--; renderSpread(currentSpreadIndex); });
    }
}
